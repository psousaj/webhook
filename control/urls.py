...
from control.functions import init_app, check_client_response_viewset, transfer_ticket_viewset

urlpatterns = [
    path('', ControlMessageViewSet.as_view({'get': 'list'}), name='tickets'),
    path('/init', init_app, name='init'),
    path('/transfer-ticket', transfer_ticket_viewset, name='transfer-ticket'),
